Reviewer.create([
  ...
  {code: '4', name: 'あぷまがどっとねっと', url: 'http://appmaga.net/', feed_url: 'http://appmaga.net/feed'},
  ...
  {code: '7', name: 'App Woman', url: 'http://appwoman.jp/', feed_url: 'http://appwoman.jp/feed'},
  ...
  {code: '12', name: 'iStation', url: 'http://iphones.cx/', feed_url: 'http://iphones.cx/atom.xml'},
